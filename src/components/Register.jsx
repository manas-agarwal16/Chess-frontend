    ...
    <div className="flex justify-center items-center h-full mx-auto w-full px-4 pt-2 text-white">
      <div className="p-4 pb-3 border-[2px] rounded-lg shadow-md text-white max-w-2xl w-full">
        <div className="flex items-center justify-center">
          <h2 className="text-2xl font-bold mb-3 text-center font-sans" >Register</h2>
        </div>
        <form onSubmit={handleSubmit(handleRegister)}>
          ...
          <div className="mb-3">
            ...
            />
            {errors.handle && (
              <p className="text-sm text-red-500 mt-1">{errors.handle.message}</p>
            )}
          </div>
          ...
          <div className="mb-3">
            <p className="text-white">
              ...
              <Link
                to={"/login"}
                className="text-gray-700 text-sm underline hover:text-gray-800 transition duration-200"
              >
                Login
              </Link>{" "}
            </p>
